...
public class BuildingReport {
  ...
  /**
   * This method is used to get the string representation of the BuildingReport object.
   *
   * @return the string representation of the BuildingReport object.
   */
  @Override
  public String toString() {
    return "BuildingReport:\nNumber of floors: " + numFloors
        ...
        + "\nElevator reports: " + Arrays.toString(elevatorReports) + "\n";
  }
}
